    ...
    <div className={`${styles.container} container-fluid`}>
      ...
      <div className="col mb-4">
          <div className={`${styles.card} card`}>
            ...
            <div  class={`${styles.cardtext} card-text`}>Computer Science & Engineering</div>
          </div>
      </div>
        ...
        <div className="col mb-4">
          <div className={`${styles.card} card`}>
            ...
            <div class={`${styles.cardtext} card-text`}>Information Technology</div>
          </div>
        </div>
        <div className="col mb-4">
          <div className={`${styles.card} card`}>
            <img src="/images/department3.webp" className="card-img-top" alt="Department 3" />
            <div class={`${styles.cardtext} card-text`}>Aritificial Intelligence</div>
          </div>
        </div>
        <div className="col mb-4">
          <div className={`${styles.card} card`}>
            <img src="/images/department4.jpeg" className="card-img-top" alt="Department 4" />
            <div class={`${styles.cardtext} card-text`}>Cyber Security</div>
        ...
        <div className="col mb-4">
          <div className={`${styles.card} card`}>
            ...
            <div class={`${styles.cardtext} card-text`}>Electronics & Communication Engineering</div>
        ...
        <div className="col mb-4">
          <div className={`${styles.card} card`}>
            ...
            <div class={`${styles.cardtext} card-text`}>Electrical & Electronic Engineering.</div>
        ...
        <div className="col mb-4">
          <div className={`${styles.card} card`}>
            ...
            <div class={`${styles.cardtext} card-text`}>Civil Engineering</div>
          </div>
        </div>
        <div className="col mb-4">
          <div className={`${styles.card} card`}>
            <img src="/images/department8.jpg" className="card-img-top" alt="Department 8" />
            <div class={`${styles.cardtext} card-text`}>Mechanical Engineering</div>
          </div>
        </div>
      </div>
    </div>
